...
<form name="line-item" method="get" action="SEARCH_LINE_ITEMS_RESULTS.php" >
          ...
          <tr>
            ...
            <td width="100%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <tr>
                 <td height="30" colspan="2" align="center" class="Labels">For Which Doctor? (Blank for all)
             ...
             <?php for ($key=0; $key<$numdocs; $key++) { 
              ...
              <tr>
                <td height="46" colspan="2" align="center" class="Verdana12">
                
                <label>
                Search for:&nbsp;
                <input name="company" type="text" class="Input" id="company" size="50" maxlength="50" onfocus="InputOnFocus(this.id)" onblur="InputOnBlur(this.id)" value=""/>
                </label>&nbsp;&nbsp;&nbsp;&nbsp;<br />
                </td>
              </tr>
