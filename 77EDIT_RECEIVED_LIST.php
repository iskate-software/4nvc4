...
$insert_INVENTOR = "INSERT INTO INVENTOR (`UNITS`, `CODE`, `DESCRIP`, VPCCODE, BACKORDER, DRUGCOST, PACKAGE) VALUES ('$_POST[units]',  '$row_INVENTOR[CODE]', '$row_INVENTOR[DESCRIP]', '$_GET[soldid]', '$backorder', '$_POST[drugcost]', '$_POST[package]')";
...
<title>EDIT RECEIVED LIST ITEM</title>
<!-- InstanceEndEditable -->
