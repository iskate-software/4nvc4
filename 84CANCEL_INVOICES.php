...
<table width="100%" height="553" border="0" cellpadding="0" cellspacing="0">
        ...
        <td width="139" colspan="2" rowspan="4" align="center"><table width="100%" border="1" cellspacing="0" cellpadding="0" id="table2">
            <tr>
              <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td width="41%" height="20" align="right" class="Labels2"><script type="text/javascript">document.write(sessionStorage.custprevbal);</script></td>
                    <td width="59%" height="20" class="Labels2">&nbsp;Balance</td>
                  </tr>
                  <tr>
                    <td height="20" align="right" class="Labels2"><script type="text/javascript">document.write(sessionStorage.custcurbal);</script></td>
  ...
  <tr>
    ...
    <tr>
      ...
      <iframe src="CANCEL_INVOICES_IFRAME.php" scrolling="no" height="100%" width="100%" frameborder="0" ></iframe>
