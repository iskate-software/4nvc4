...
<table border="0" cellspacing="0" cellpadding="0">
  ...
  <tr bgcolor="#000000" class="Verdana11Bwhite">
    <td width="130" height="10" align="left">Invoice #</td>
    <td width="130" align="left">Date & Time</td>
    <td width="200" align="left">Client</td>
    <td width="" align="left">Staff</td>
  ...
  <tr>
    <td width="50" height="0" align="left"></td>
  ...
  do {
  echo '
  <tr id="'.$row_REJECTIN['REJINV'].'" onmouseover="highliteline(this.id,\'#DCF6DD\');" onmouseout="whiteoutline(this.id)">
    <td width="" align="center" class="Verdana13">';
	if ($row_REJECTIN['REJINV']=='0'){echo "ESTIMATE";}
	else {echo $row_REJECTIN['REJINV'];}
  echo '&nbsp;</td>
    <td width="" align="center" class="Verdana13">'.$row_REJECTIN['INVDTE'].'</td>
    <td width="" class="Verdana13" align="left">'.substr($row_REJECTIN['COMPANY'],0,29).'</td>
    <td width="" align="left" class="Verdana13">'.$row_REJECTIN['STAFF'].'</td>
    <td width="" align="right" class="Verdana13">'.number_format(($row_REJECTIN['ITOTAL']),2).'&nbsp;</td>
  </tr>';
  }
  while ($row_REJECTIN=mysqli_fetch_assoc($REJECTIN));
  ?>
