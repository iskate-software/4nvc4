...
<div id="inuse" title="File in memory">
  <?php // if (empty($_SESSION['fileused'])){echo"&nbsp;"; } else {echo substr($_SESSION['fileused'],0,25);}  ?>
</div>



<div id="WindowBody" style="height:500px; overflow:auto;">

  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td width="21%" align="left" bgcolor="#000000" class="Andale11Bwhite style1">COMMCODE</td>
      <td width="79%" align="left" bgcolor="#000000" class="Andale11Bwhite style1">COMMENT</td>
    </tr>
    <?php do { ?>
      <tr>
