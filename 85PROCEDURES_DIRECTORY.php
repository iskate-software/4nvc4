...
var i=loc-1;
	{
	document.proc_directory.specie.options[i].selected="selected";
	}
category();
}
...
self.location='PROCEDURES_DIRECTORY.php?species=' + spec;
}
...
var loc=<?php echo $_GET['species']; ?>;
window.open('PROCEDURES_LIST_IFRAME.php?category=' + cat + '&species=' +loc ,'tfflist','toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no');
}
...
window.open('QUICK_PROCEDURE.php?species='+loc,'_blank', 'height=259, width=380');
}
}
...
window.open('RENUMBER_PROCEDURE.php?species='+loc,'_blank', 'height=430, width=380');
}
}

function updte_procedure(){
var cat=document.getElementById('category1').value;
window.open('UPDATE_PROCEDURE.php?category='+cat + '&species=<?php echo $_GET['species']; ?>','_self');
}
...
<form action="" method="post" class="FormDisplay" name="proc_directory">
<table width="100%" height="553" border="0" cellpadding="0" cellspacing="0">
  <tr height="10">
    ...
    <td width="231" align="center" valign="middle" bgcolor="#000000" class="Verdana11Bwhite">Procedure</td>
  ...
  <tr>
    ...
    <input type="button" name="button9" class="CustomizedButton1" value="ADD PROC." onclick="OpenAddCategory();" title="Add procedure" />
    <input name="" class="CustomizedButton1" type="button" value="PROCEDURES" title="Edit category" onclick="MaintainCategory()" />
    <input name="" class="CustomizedButton1" type="hidden" value="REPORT" title="Display report" onclick="window.open('REPORT.php?species=<?php echo $_GET['species']; ?>&category=i','_blank','width=380,height=470');" />
    <input name="" class="CustomizedButton1" type="hidden" value="GLOBAL FEE CH." disabled="disabled" title="Global fee changes" />
    <input name="" class="CustomizedButton1" type="button" value="CANCEL" onclick="document.location='../../INDEX.php';" />    
    </td>
    </tr>
</table>
