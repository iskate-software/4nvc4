...
<title>INVENTORY SALES REGISTER</title>
<!-- InstanceEndEditable -->
...
<form name="inventory_register" method="get" action="INVENTORY_REGISTER_RESULTS.php" >

<table width="732" height="553" border="0" cellpadding="0" cellspacing="0" bgcolor="#00BFFF">
  <!--DWLayoutTable-->
  <tr>
          ...
          <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                &nbsp;&nbsp;&nbsp;
                <label>&nbsp;
                  <input type="radio" name="file2search" id="radio" value="DVMINV" checked="checked" />
              ...
              <tr>
                ...
                &nbsp;&nbsp;&nbsp;
                <label>&nbsp;
                  <input type="radio" name="file2search" id="radio2" value="DVMILAST" onchange="document.inventory_register.startdate.value='';document.inv_register.enddate.value='';"/>
              ...
              <tr>
                ...
                &nbsp;&nbsp;&nbsp;
                <label>&nbsp;
                  <input type="radio" name="file2search" id="radio3" value="ARYDVMI" onchange="document.inventory_register.startdate.value='';document.inv_register.enddate.value='';"/>
            ...
            <td width="54%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td height="25" colspan="2" align="center" class="Verdana12"><input type="button" name="button" id="button" value="Clear Dates" onclick="document.inventory_register.startdate.value='';document.inventory_register.enddate.value='';" /></td>
              </tr>
              <tr>
