...
<form name="act_register" method="get" action="ACTIVITY_REGISTER_RESULTS.php" >
    ...
    <td align="center" valign="top"><div id="shadow">
      <div id="shadowedtable">
        <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#446441" frame="void" rules="cols">
          <tr>
            <td width="46%" align="center" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
              ...
              <tr>
                ...
                &nbsp;&nbsp;&nbsp;
                <label>&nbsp;
                  <input type="radio" name="file2search" id="radio2" value="DVMILAST" />
              ...
              <tr>
                ...
                &nbsp;&nbsp;&nbsp;
                <label>&nbsp;
                  <input type="radio" name="file2search" id="radio3" value="ARYDVMI" />
            ...
            <td width="54%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td height="25" colspan="2" align="center" class="Verdana12"><label>
                  <input type="button" name="button" id="button" value="Clear Dates" onclick="document.act_register.startdate.value='';document.act_register.enddate.value='';" />
                </label></td>
              </tr>
              <tr>
                <td height="25" colspan="2" align="left" class="Verdana12"><label></label></td>
                </tr>
              <tr>
                <td height="25" colspan="2" align="left" class="Verdana12">&nbsp;</td>
              </tr>
            </table></td>
          </tr>
          <tr>
